...
> App Store Connect API로 옮기면 적법해지고 수집량도 늘어난다. 붙이려면 **판매자 계정 2곳에서 각각
...
| 30일 수집량 | **11건** (부정 8건, 심각 3건) — 2026-08-29 DB 실측, 작성일 기준. 전 기간 누적은 344건(2022-02-25 ~ 2026-08-16), 전부 한 국가 스토어 |
...
- **규모(DB 실측 2026-08-29)**: 기존 `appstore` 행 **344건** (2022-02-25 ~ 2026-08-16).
...
**키 2벌 각각에 대해 돌린다.** 계정마다 따로 실패할 수 있다.
...
- **키 2벌 각각 찍는다.** 한도는 **API 키당**이므로 계정마다 다를 수 있다.
